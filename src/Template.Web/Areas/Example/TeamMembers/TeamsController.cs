...
namespace Template.Web.Areas.Example.TeamMembers
{
    ...
    public partial class TeamMembersController : AuthenticatedBaseController
    {
        ...
        public TeamMembersController(SharedService sharedService, IPublishDomainEvents publisher, IStringLocalizer<SharedResource> sharedLocalizer)
        {
        ...
        {
            var teamMembers = await _sharedService.Query(model.ToTeamMembersIndexQuery());
            model.SetTeamMembers(teamMembers);
